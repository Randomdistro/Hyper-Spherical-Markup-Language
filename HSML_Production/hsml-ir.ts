...
export class HSMLIRBuilder {
    ...
    private processSphericalCoordinate(coord: any): IRExpression {
        ...
        return {
            ...
            dependencies: new Set(),
            optimizationHints: [],
            value: { r: r.constantValue, theta: theta.constantValue, phi: phi.constantValue },
            resultType: this.getType('spherical_coord'),
            isConstant: r.isConstant && theta.isConstant && phi.isConstant,
            constantValue: { r: r.constantValue, theta: theta.constantValue, phi: phi.constantValue },
            sphericalCoordinate: {
                r,
                theta,
                phi,
    ...
    private processSolidAngle(angle: any): IRExpression {
        ...
        return {
            ...
            dependencies: new Set(),
            optimizationHints: [],
            value: { omega: omega.constantValue, theta_min: theta_min.constantValue, theta_max: theta_max.constantValue, phi_min: phi_min.constantValue, phi_max: phi_max.constantValue },
            resultType: this.getType('solid_angle'),
            isConstant: omega.isConstant && theta_min.isConstant && theta_max.isConstant && phi_min.isConstant && phi_max.isConstant,
            constantValue: { omega: omega.constantValue, theta_min: theta_min.constantValue, theta_max: theta_max.constantValue, phi_min: phi_min.constantValue, phi_max: phi_max.constantValue },
            solidAngle: {
                omega,
                theta_min,
                theta_max,
    ...
    private processMatterState(state: any): IRExpression {
        ...
        return {
            ...
            optimizationHints: [],
            value: state.state,
            resultType: this.getType('matter_state'),
            isConstant: true,
            constantValue: state.state,
            matterState: {
                state: state.state,
                properties,
